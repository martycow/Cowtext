...
description: Canonical Cowtext vocabulary — module map, the 50 invoke commands, the two Tauri events, and the terms every agent must use consistently. Load before writing code, docs, or reports so names stay byte-exact. Full definitions live in docs/TERMINOLOGY_REFERENCE.md.
---
...
| Module | Owns |
|---|---|
| `src-tauri/src/lib.rs` | Builder chain, plugin registration, `generate_handler!` list (50) |
...
## Invoke commands (50) — byte-exact names
