// Theme extension generated from src/styles/tokens.css — see docs/design/DESIGN_SPEC.md.
    ...
    extend: {
      colors: {
        ...
        edge: {
          ...
          overrides:      'var(--edge-overrides)',
          supersedes:     'var(--edge-supersedes)',
          'conflicts-with': 'var(--edge-conflicts-with)',
