...
| WO17 P0.2 Fold eight per-WO manuals into one regression list | new | critical | wo17, p0, qa, acceptance |  | WO01/02/03/06/09/10/11/12/13 walked separately will never close, and they are release gate 2. Extract only what `GOLDEN_PATH_MANUAL.md` does not cover — 20–30 steps instead of eight runs. Deliberately lowers the bar; a bar nobody clears protects nothing. Needs Marty's yes because it redefines gate 2 in ROADMAP §Release gate. |
